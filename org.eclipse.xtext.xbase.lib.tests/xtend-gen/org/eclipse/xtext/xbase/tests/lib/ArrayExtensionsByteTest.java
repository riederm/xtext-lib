...
public class ArrayExtensionsByteTest {
  ...
  public void testContains__byte() {
    Assert.assertTrue(((List<Byte>)Conversions.doWrapArray(this.data)).contains(Byte.valueOf(((byte) 10))));
    Assert.assertTrue(((List<Byte>)Conversions.doWrapArray(this.data)).contains(Byte.valueOf(((byte) 20))));
    Assert.assertTrue(((List<Byte>)Conversions.doWrapArray(this.data)).contains(Byte.valueOf(((byte) 30))));
    Assert.assertFalse(((List<Byte>)Conversions.doWrapArray(this.data)).contains(Byte.valueOf(((byte) 40))));
  }
}
