...
public class ArrayExtensionsCharTest {
  ...
  public void testContains__char() {
    Assert.assertTrue(((List<Character>)Conversions.doWrapArray(this.data)).contains(Character.valueOf(this.a)));
    Assert.assertTrue(((List<Character>)Conversions.doWrapArray(this.data)).contains(Character.valueOf(this.b)));
    Assert.assertTrue(((List<Character>)Conversions.doWrapArray(this.data)).contains(Character.valueOf(this.c)));
    Assert.assertFalse(((List<Character>)Conversions.doWrapArray(this.data)).contains(Character.valueOf(this.x)));
  }
}
